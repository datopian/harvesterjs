...
import { listAllDatasets } from "../lib/obs";
import { type ODSDataset } from "@/schemas/ods";


@Harvester
class OpenDataSoftHarvester extends BaseHarvester<ODSDataset> {
  ...
  mapSourceDatasetToTarget(ds: ODSDataset): PortalJsCloudDataset {
